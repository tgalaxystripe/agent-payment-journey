...
const JOURNEYS = [
  {
    ...
    with: {
      ...
      steps: [
        ...
        { t: 44,  kind: "wall", label: "Sign-in wall",      detail: "Buy It Now redirects to the sign-in page — exactly as the advice predicted. Pulls the guest-checkout URL out of the page’s own gchru parameter." },
        ...
        { t: 128, kind: "wait", label: "Waiting on human",  detail: "Not counted as the agent’s working time.", waitUntil: 713 },
        { t: 713, kind: "step", label: "Approved",          detail: "Spend request approved. Card issued." },
        { t: 818, kind: "step", label: "Payment submitted", detail: "Confirm and pay, total $9.25." },
...

  {
    ...
    with: {
      ...
      steps: [
        ...
        { t: 112, kind: "wait", label: "Waiting on human",  detail: "Not counted as the agent’s working time.", waitUntil: 130 },
        { t: 130, kind: "step", label: "Approved",          detail: "Spend request approved." },
        { t: 282, kind: "step", label: "Payment submitted", detail: "Place Order, total $7.63." },
...

  {
    ...
    without: {
      ...
      steps: [
        ...
        { t: 233, kind: "wait", label: "Waiting on human",  detail: "Not counted as the agent’s working time.", waitUntil: 874 },
        { t: 874, kind: "step", label: "Approved",          detail: "Spend request approved. Card issued." },
    ...
    with: {
      ...
      steps: [
        ...
        { t: 120, kind: "wait", label: "Waiting on human",  detail: "Not counted as the agent’s working time.", waitUntil: 131 },
